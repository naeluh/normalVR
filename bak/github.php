...
$salt = '302556248';
$pass = '85798bc1c7b8a8cd96e17516027814f6';
// End copy and paste


// Defaults
$projectName = 'normalVR'; // Your project name
$email		 = 'naeluh@gmail.com'; // Email address you want pull notifcations to go to
...
if (isset($_GET['update'])) {
	...
	if ($pass === $check) {
		...
		// what does the pull
		$output = shell_exec('/var/www/hulea/public_html/work/normalVR git pull origin master');
